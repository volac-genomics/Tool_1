...
inputContigs = Channel.fromPath("$baseDir/input_tool1/*.fa", type: 'file')
...
def helpMessage() {
    log.info """
        ...
        Queries all *.fa files in input_tool1/ 
        Downloads current database and provides summary file.
        Usage: nextflow run tool_1.nf [options]
	...
	nextflow run tool_1.nf --abricateDB 'resfinder' --identity '90' --coverage '75'
        ...
        ALTERNATIVE: to run tool with every strain use tool_1_EVERYTHING.nf
